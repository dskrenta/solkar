...
function sayHello (data) {
  ...
  var hello = function hello(input) {
    return input;
  };

  var hello1 = function hello1(input) {
    return input;
  };

  var hello2 = function hello2(input) {
    return input;
  };

  var hello3 = function hello3(input) {
    return input;
  };
}
...
riot$1.tag2('sample', '<h1>Hello, {name}.</h1> <p>I am a riot tag!</p>', '', '', function (opts) {
    this.name = 'David';
});
...
var david = new Person('David', 17, 200, 165);
var point = new Coord(100, 100, 'pizza');

var stuff = david.toString();
console.log(stuff);
point.toString();